...
#         agent_formset = AgentFormSet(request.POST, request.FILES, prefix='agent')
#         location_formset = LocationFormSet(request.POST, request.FILES, prefix='location')
#         address_formset = AddressFormSet(request.POST, request.FILES, prefix='address')
#
#         if agent_formset.is_valid() and location_formset.is_
